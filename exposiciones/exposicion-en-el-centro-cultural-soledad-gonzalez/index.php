...
<head>
    ...
    <title>Exposición "Bichos" en el centro cultural Soledad González | Esculturas en hierro</title>
    ...
    <link href="../css/exposicion.css" type="text/css" rel="stylesheet" />
            ...
            <div class="principal">
                ...
                <?php
                    for ($i = 0; $i < count($imagenes); $i++) {
                        echo "<img src='images/" . $imagenes[$i] . "'>";
                    }
                ?>
                </div>
                <div class="pie">
                    El escultor al lado del alcalde y de la concejal de cultura de Benavente.
                </div>
