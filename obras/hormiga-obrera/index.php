...
<head>
    ...
    <title>Hormiga Obrera | Esculturas en hierro</title>
...
<body>
    ...
    <section>
        <div class="container">
            <span class="nombre-responsive">Hormiga Obrera</span>
                <!-- <span class="precio-responsive">1.500,00 €</span> -->
            <div class="galeria">
                <div class="principal">
                    <img src="../images/HormigaObrera1.jpg" alt="">
                </div>
                <div class="todas">
                    <div class="foto">
                        <img src="../images/HormigaObrera1.jpg" alt="">
                    ...
                    <div class="foto">
                        <img src="../images/HormigaObrera2.jpg" alt="">
                    </div>
                    <div class="foto">
                        <img src="../images/HormigaObrera3.jpg" alt="">
                    </div>
                    <div class="foto">
                        <img src="../images/HormigaObrera4.jpg" alt="">
                    </div>
                </div>
            </div>
