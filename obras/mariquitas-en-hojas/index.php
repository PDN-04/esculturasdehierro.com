...
<head>
    ...
    <title>Mariquitas en Hojas | Esculturas en hierro</title>
...
<body>
    ...
    <section>
        <div class="container">
            <span class="nombre-responsive">Mariquitas en Hojas</span>
            <!-- <span class="precio-responsive">1.300,00 €</span> -->
            <div class="galeria">
                <div class="principal">
                    <img src="../images/MariquitasEnHojas1.jpg" alt="">
                </div>
                <div class="todas">
                    <div class="foto">
                        <img src="../images/MariquitasEnHojas1.jpg" alt="">
                    ...
                    <div class="foto">
                        <img src="../images/MariquitasEnHojas2.jpg" alt="">
                    </div>
                    <div class="foto">
                        <img src="../images/MariquitasEnHojas3.jpg" alt="">
                    </div>
                    <div class="foto">
                        <img src="../images/MariquitasEnHojas4.jpg" alt="">
                    </div>
                </div>
            </div>
