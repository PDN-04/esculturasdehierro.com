...
<head>
    ...
    <title>Mosca | Esculturas en hierro</title>
...
<body>
    ...
    <section>
        <div class="container">
            <span class="nombre-responsive">Mosca</span>
            <!-- <span class="precio-responsive">400,00 €</span> -->
            <div class="galeria">
                <div class="principal">
                    <img src="../images/Mosca1.jpg" alt="">
                </div>
                <div class="todas">
                    <div class="foto">
                        <img src="../images/Mosca1.jpg" alt="">
                    ...
                    <div class="foto">
                        <img src="../images/Mosca2.jpg" alt="">
                    </div>
                    <div class="foto">
                        <img src="../images/Mosca3.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="descripcion">
                <span class="nombre">Mosca</span>
                <!-- <span class="precio">400,00 €</span> -->
