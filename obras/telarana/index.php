...
<head>
    ...
    <title>Telaraña | Esculturas en hierro</title>
...
<body>
    ...
    <section>
        <div class="container">
            <span class="nombre-responsive">Telaraña</span>
            <span class="precio-responsive">1.000,00 €</span>
            <div class="galeria">
                <div class="principal">
                    <img src="../images/Telarana1.jpg" alt="">
                </div>
                <div class="todas">
                    <div class="foto">
                        <img src="../images/Telarana1.jpg" alt="">
                    ...
                    <div class="foto">
                        <img src="../images/Telarana2.jpg" alt="">
                    </div>
                    <div class="foto">
                        <img src="../images/Telarana3.jpg" alt="">
                    </div>
                    <div class="foto">
                        <img src="../images/Telarana4.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="descripcion">
                <span class="nombre">Telaraña</span>
                <span class="precio">1.000,00 €</span>
